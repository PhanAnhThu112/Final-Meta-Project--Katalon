...
//
//WebUI.setEncryptedText(findTestObject('Object Repository/Page_META.vn - Mua sm trc tuyn/input_form-input form-p'), 'Vj63fjYkfxFa46erj/rUPQ==')
//
//WebUI.sendKeys(findTestObject('Object Repository/Page_META.vn - Mua sm trc tuyn/input_form-input form-p'), Keys.chord(Keys.ENTER))
//
//WebUI.click(findTestObject('Object Repository/Page_META.vn - Mua sm trc tuyn/span_toggle-view show'))
//
//WebUI.setText(findTestObject('Object Repository/Page_META.vn - Mua sm trc tuyn/input_form-input form-p actived'), 'Phuong1234')
//
