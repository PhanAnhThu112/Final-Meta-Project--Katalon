...
WebUI.setText(findTestObject('Object Repository/Page_META.vn - Mua sm trc tuyn/input_form-input form-u actived'), 'thuy.bui24@student.passerellesnumeriques.org')
