...
WebUI.setText(findTestObject('Object Repository/Checkout/Page_META.vn - Mua sm trc tuyn/input_phone'), '9838479284')
...
WebUI.click(findTestObject('Object Repository/Checkout/Page_META.vn - Mua sm trc tuyn/div_Thanh ton online'))

WebUI.click(findTestObject('Object Repository/Checkout/Page_META.vn - Mua sm trc tuyn/img'))

WebUI.click(findTestObject('Object Repository/Checkout/Page_META.vn - Mua sm trc tuyn/div_Th ATM ni a, V in t, m QR'))
